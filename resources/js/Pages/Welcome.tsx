            ...
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                    <div className="text-center">
                        <p className="text-white mb-4">週単位のお小遣い管理アプリ</p>
                        <h1 className="text-white text-6xl mb-12">CHOMANE</h1>
                    </div>
                    <div className="text-center">
                        {auth.user ? (
                            <Link
                            ...
                            <>
                                <Link
                                    href={route('register')}
                                    className="block bg-white rounded-full px-4 py-2 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                                >
                                    新規アカウント作成
                                </Link>
                                ...
                                <Link
                                        href={route('login')}
                                        className="block mt-6 bg-white rounded-full px-4 py-2 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                                    >
                                        ログイン
                                </Link>
